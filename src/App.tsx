...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-bg-light text-text-primary flex flex-col font-sans transition-colors duration-300">
      ...
      {showReader && (
        <div className="fixed inset-0 bg-text-primary/85 backdrop-blur-md z-50 flex items-center justify-center p-4 animate-fade-in">
          <div className="bg-surface-card rounded-2xl max-w-2xl w-full overflow-hidden shadow-2xl border border-border-light flex flex-col h-[520px]">
            ...
            <div className="bg-surface-container px-6 py-4 border-b border-border-light flex items-center justify-between">
              ...
              <button 
                ...
                className="text-text-muted hover:text-text-primary p-1 hover:bg-surface-container-high rounded-full transition-colors"
                title="Exit reader"
              >
                <X className="w-5 h-5" />
              </button>
            ...
            <div className="p-8 flex-grow overflow-y-auto font-serif space-y-4 text-sm text-text-primary select-none bg-[#fdfbf7]">
              <h3 className="font-display text-lg font-bold tracking-tight text-center border-b pb-4 mb-4 not-serif text-text-secondary">
                {readerBookTitle}
              </h3>

              {readerPage === 1 && (
                <div className="space-y-4">
                  <p className="first-letter:text-4xl first-letter:font-bold first-letter:float-left first-letter:mr-2 leading-relaxed">
              ...
              {readerPage === 2 && (
                <div className="space-y-4">
                  ...
                  <p className="leading-relaxed">
                    Therefore, let us pair Inter and Geist. Let the display text represent the mathematical rigour of modern engineering, while long-form paragraphs represent the flowing tradition of classic prose. In this convergence, we find serenity.
                  </p>
                </div>
              )}
              ...
              {readerPage === 3 && (
                <div className="space-y-4 text-center py-10">
                  ...
                  <h4 className="font-display font-bold text-sm text-text-primary">Chapter Finished!</h4>
                  ...
                  <div className="pt-4">
                    <button
                      onClick={() => {
                        // Increase reward points slightly
                      ...
                      className="px-6 py-2 bg-primary-blue text-white text-xs font-display font-semibold rounded-lg hover:bg-primary-blue-container transition-all"
                    >
            ...
            <div className="bg-surface-container px-6 py-3 border-t border-border-light flex items-center justify-between text-xs font-sans">
              <button 
                ...
                className="px-3 py-1 bg-surface-card border rounded hover:bg-surface-container-high disabled:opacity-40"
              >
                Previous
              </button>
              ...
              <button 
                ...
                className="px-3 py-1 bg-primary-blue text-white rounded hover:bg-primary-blue-container disabled:opacity-40 font-semibold"
              >
                Next Page
              </button>
            </div>
